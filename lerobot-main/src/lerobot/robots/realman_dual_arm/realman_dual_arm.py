...
class RealManDualArmRobot(Robot):
    ...
    @property
    def observation_features(self):
        return {"observation.state": {"dtype": "float32", "shape": (14,), "names": ["left_joint_1", "left_joint_2", "left_joint_3", "left_joint_4", "left_joint_5", "left_joint_6", "left_gripper", "right_joint_1", "right_joint_2", "right_joint_3", "right_joint_4", "right_joint_5", "right_joint_6", "right_gripper"]}}
    ...
    def connect(self):
        ...
        try:
            ...
            # === [新增] 3. 初始化 Modbus 夹爪 ===
            print("  - Initializinrm_write_registersg Modbus Grippers...")
